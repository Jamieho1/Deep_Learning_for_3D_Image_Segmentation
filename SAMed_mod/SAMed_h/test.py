...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/home/sist/kdzhang/data/test_vol_h5')
    parser.add_argument('--dataset', type=str, default='Synapse', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=8)
    parser.add_argument('--list_dir', type=str, default='./lists/lists_Synapse/', help='list_dir')
    parser.add_argument('--output_dir', type=str, default='/home/sist/kdzhang/results/SAMed_accelerate/results')
    ...
    parser.add_argument('--lora_ckpt', type=str, default='/home/sist/kdzhang/results/SAMed_accelerate/Synapse_512_pretrain_vit_h_epo200_bs24_lr0.005/epoch_159.pth', help='The checkpoint from LoRA')
